...
int LoadDeviceIcons(struct UIDrawGlobal *gsGlobal, GS_IMAGE *Texture)
{
    return LoadPNGImage(gsGlobal, Texture, NULL, devices, size_devices);
}
...
void DrawDeviceIcon(struct UIDrawGlobal *gsGlobal, GS_IMAGE *IconTexture, unsigned char icon, short int x, short int y, short int z)
{
